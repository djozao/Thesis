...
intervals = [52, 62; 112, 122; 172, 182; 232, 242; 292, 302]; % Define your intervals here
...
filename = '20240325 FOURTH\pressure_4.txt'; % Replace 'your_file.txt' with the actual filename
...
plot(time_pressure, pressure2, 'b-'); % Plot original pressure2 in blue
hold on;
...
intervals = [35, 61; 95, 121; 155, 181; 215, 241 ; 275, 302]; % Adjust as needed
...
time_intervals_no_load = [11, 30; 72, 90; 132, 150; 193, 209; 253, 270];
time_intervals_load = [36, 61; 95, 121 ; 156, 182 ; 215, 242 ; 276, 302];
...
viscosity = 1.7395*10^-5;
density = 5.8544;% 7.0272
% 1.7410e-05;
